...
| SPR-019 | CKO Local Knowledge Finder MVP Implementation | [Implementation plan](SPR-019_CKO_LOCAL_KNOWLEDGE_FINDER_MVP_IMPLEMENTATION_PLAN.md) | No implementation report; no increment started | `PLANNED / HUMAN_RATIFIED / IMPLEMENTATION_NOT_STARTED` |
